...
namespace TelegramBot.DBDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ((@IsNull_userId = 1 A" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Users] SET [userId] = @userId WHERE (([Id] = @Original_Id) AND ((@I" +
                "sNull_userId = 1 AND [userId] IS NULL) OR ([userId] = @Original_userId)));\r\nSELE" +
                "CT Id, userId FROM Users WHERE (Id = @Id)";
